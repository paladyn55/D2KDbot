...
def stat_get(bungieName, b_num):
	...
	# --------------------------------------------------------------------------------------------------
	stats = requests.get("https://www.bungie.net/platform/Destiny2/" + membershipType + "/Account/" + membershipId + "/Character/0/Stats/?groups=General&modes=10,12,37,84",headers=HEADERS)
